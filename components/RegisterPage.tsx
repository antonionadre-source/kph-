...
import { Lock as LockIcon, Mail as MailIcon, User as UserIcon } from 'lucide-react';
      ...
      >
        <div className="bg-white/5 backdrop-blur-3xl p-10 rounded-[3rem] border border-white/10 shadow-[0_50px_100px_rgba(0,0,0,0.5)]">
          <div className="text-center mb-10">
            ...
            <h2 className="text-4xl font-black text-white tracking-tighter uppercase mb-2">{t('register.title')}</h2>
            <p className="text-white/40 font-bold text-sm uppercase tracking-[0.2em]">Partner Registration</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label htmlFor="name" className="block text-[10px] font-black text-white/40 uppercase tracking-[0.3em] ml-4">
                {t('register.name')}
              </label>
            ...
            >
              {isLoading ? 'Processing...' : t('register.button')}
            </motion.button>
          </form>
